...
- (void)countDown{
    if (_count > 0){
        ...
        //字体变化大小
        NSValue *value1 = [NSNumber numberWithFloat:fontSize/2];
        NSValue *value2 = [NSNumber numberWithFloat:fontSize/4];
        NSValue *value3 = [NSNumber numberWithFloat:fontSize/8];
