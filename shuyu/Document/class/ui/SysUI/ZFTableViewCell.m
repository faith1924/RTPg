...
- (void)setLayout:(ZFTableViewCellLayout *)layout {
    ...
    self.lineView.frame = layout.lineViewRect;
    ...
    [self.headImageView setImageWithURLString:layout.data.profile_image placeholder:[UIImage imageNamed:@"defaultUserIcon"]];
    [self.coverImageView setImageWithURLString:layout.data.bimageuri placeholder:[UIImage imageNamed:@"loading_bgView"]];
    [self.bgImgView setImageWithURLString:layout.data.bimageuri placeholder:[UIImage imageNamed:@"loading_bgView"]];
    self.nickNameLabel.text = layout.data.name;
...
- (void)setNormalMode {
    ...
    self.titleLabel.textColor = JYMiddleColor;
    self.nickNameLabel.textColor = JYDeepColor;
    self.contentView.backgroundColor = [UIColor whiteColor];
}
