...
//  ABCMobileProject
//
//  Created by mylm on 2018/9/3.
//  Copyright © 2018年 mylm. All rights reserved.
//

#import "JYKeychainObjc.h"

NSString * const KEY_UUID_INSTEAD = @"lpChain";

@implementation JYKeychainObjc
+ (NSString *)getDeviceIDInKeychain
{
    ...
    if (!getUDIDInKeychain || [getUDIDInKeychain isEqualToString:@""] || [getUDIDInKeychain isKindOfClass:[NSNull class]]) {
        ...
        [JYKeychainObjc save:KEY_UUID_INSTEAD data:result];
        getUDIDInKeychain = (NSString *)[JYKeychainObjc load:KEY_UUID_INSTEAD];
    }
