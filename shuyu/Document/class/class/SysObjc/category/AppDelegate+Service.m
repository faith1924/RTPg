...
- (void)JYConfAdView{
    ...
    imageAdconfiguration.imageNameOrURLString = @"adver.png";
...
//    [AVOSCloud setAllLogsEnabled:YES];
    ...
    if ([LeanCloudResModel shareCloudModel].status == YES) {
        [LeanCloudInterface userLoginName:WDLTurnIdToString([LeanCloudResModel shareCloudModel].userInfo[@"username"]) password:WDLTurnIdToString([LeanCloudResModel shareCloudModel].userInfo[@"password"]) result:^(BOOL status) {
            JYLog(@"登录成功");
        }];
    }
}
