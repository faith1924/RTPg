...
//    new_Params;
//    PARAMS(params, @"version", WDLAppVersion);
//    JYAfClient
//    [JYAfClient getAppVersionNumberUrlWithParams:params andCompleteBlock:^(id data) {
//        if ([data[@"errMsg"] isEqualToString:@"00000"]) {
//            if (![data[@"retData"][@"status"] isEqual:@(-1)]) {
//                LYAlertController * alertController = [LYAlertController alertControllerWithTitle:@"发现新版本" message:WDLTurnIdToString(data[@"retData"][@"content"]) preferredStyle:UIAlertControllerStyleAlert];
//                alertController.messageTextAlignment = NSTextAlignmentLeft;
//
//                if ([data[@"retData"][@"status"] isEqual:@(2)]) {
...
//                        NSString * textURL = WDLTurnIdToString(data[@"retData"][@"download"]);
